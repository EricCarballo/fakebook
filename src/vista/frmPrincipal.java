...
import static vista.frmPerfil.txtCorreo;
import static vista.frmPerfil.txtFecha;
import static vista.frmPerfil.txtPublicaciones;
...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void ShowJPanel(JPanel p) {
        ...
        List<Document> publicaciones = PC.listarPublicaciones();

        for (Document pc : publicaciones) {
            JPanel panelPublicacion = new JPanel();
            panelPublicacion.setLayout(new GridLayout(3,1));
            publicacionesModel prc = gson.fromJson(pc.toJson(), publicacionesModel.class);

            frmMural.txtCorreo.setText(prc.getCorreo());
            frmMural.txtDate.setText(prc.getFechaHora());
            frmMural.txtPublicaciones.setText(prc.getContenido());
            
            JLabel lblCorreo = new JLabel(prc.getCorreo());
            JLabel lblPublicacion = new JLabel(prc.getContenido());
            JLabel lblFecha = new JLabel(prc.getFechaHora());

            panelPublicacion.add(lblCorreo);
            panelPublicacion.add(lblPublicacion);
            panelPublicacion.add(lblFecha);
            pnlPrincipal.add(panelPublicacion, BorderLayout.CENTER);
    ...
    private void initComponents() {
        ...
        PerfilUsuario.add(btnPerfil, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 320, 80, -1));
        ...
        scp.setHorizontalScrollBar(null);
        ...
        scp.setViewportView(pnlPrincipal);

        bg.add(scp, new org.netbeans.lib.awtextra.AbsoluteConstraints(292, 72, 940, 700));
        ...
        PerfilDos.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        FotoPerfilUno2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        PerfilDos.add(FotoPerfilUno2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 70, 70));

        lblStatus2.setFont(new java.awt.Font("Sans Serif Collection", 0, 11)); // NOI18N
        PerfilDos.add(lblStatus2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 40, 20, 20));

        jLabel12.setFont(new java.awt.Font("Roboto Medium", 0, 12)); // NOI18N
        jLabel12.setText("Estatus");
        PerfilDos.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, -1, 20));

        jLabel13.setFont(new java.awt.Font("Roboto Medium", 0, 12)); // NOI18N
        jLabel13.setText("Nombre:");
        PerfilDos.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 10, -1, 20));
        ...
        PerfilDos.add(txtNombreRecomendacion2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, 120, -1));

        txtEstatus3.setFont(new java.awt.Font("Sans Serif Collection", 0, 11)); // NOI18N
        txtEstatus3.setText("Conectado");
        PerfilDos.add(txtEstatus3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 40, 60, 20));

        Recomendados.add(PerfilDos, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 260, -1));
    ...
    private void btnEntrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEntrarMouseClicked
        ...
        pub.setVisible(true);
        frmPublicar.txtCorreo.setText(txtCorreo.getText());
    ...
    private void PerfilUnoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PerfilUnoMouseClicked
        ...
        for (Document l : use) {
            ...
            frmPerfil.txtCorreo.setText(e.getCorreo());
        ...
        publicacionesController pc = new publicacionesController();
        String query = "{'correo': '" + rutaRecomendacion1.getText() + "'}";
        Document dbo = Document.parse(query);
        List<Document> publicaciones = pc.listarPublicacionesFiltro(dbo);
        Gson gson = new Gson();

        for (Document publi : publicaciones) {
            publicacionesModel p = gson.fromJson(publi.toJson(), publicacionesModel.class);

            frmPerfil.txtPublicaciones.setText(p.getContenido());
            frmPerfil.txtFecha.setText(p.getFechaHora());
        }
    ...
    private void btnPerfilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPerfilMouseClicked
        ...
        frmPerfil.txtCorreo.setText(txtCorreo.getText());
        ImageIcon iconPortada = new ImageIcon(getClass().getResource("/img/fondo3.jpg"));
        Image fotoPortada = iconPortada.getImage().getScaledInstance(560, 250, 0);
        frmPerfil.portada.setIcon(new ImageIcon(fotoPortada));

        publicacionesController pc = new publicacionesController();
        String query = "{'correo': '" + txtCorreo.getText() + "'}";
        Document dbo = Document.parse(query);
        List<Document> publicaciones = pc.listarPublicacionesFiltro(dbo);
        Gson gson = new Gson();
    ...
    private void PerfilDosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PerfilDosMouseClicked
        ...
        publicacionesController pc = new publicacionesController();
        String query = "{'correo': '" + rutaRecomendacion2.getText() + "'}";
        Document dbo = Document.parse(query);
        List<Document> publicaciones = pc.listarPublicacionesFiltro(dbo);
        Gson gson = new Gson();
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        for (Document publi : publicaciones) {
            ...
            frmMural.txtCorreo.setText(p.getCorreo());
            frmMural.txtDate.setText(p.getFechaHora());
            frmMural.txtPublicaciones.setText(p.getContenido());
        }
