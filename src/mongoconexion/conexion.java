...
public class conexion {
    ...
    public List<Document> listarPublicaciones(){
        ...
        MongoDatabase db = mongo.getDatabase("fakebook");
        MongoCollection<Document> tabla = db.getCollection("publicaciones");
        List<Document> publicaciones = tabla.find().into(new ArrayList<Document>());
    ...
    public List<Document> listarPublicacionesFiltro(Document dbo){
        MongoClient mongo = conexion();
        MongoDatabase db = mongo.getDatabase("fakebook");
        MongoCollection<Document> collec = db.getCollection("publicaciones");
        List<Document> publicaciones = collec.find(dbo).into(new ArrayList<Document>());
        return publicaciones;
    }
}
